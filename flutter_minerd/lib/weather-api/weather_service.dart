...
class WeatherService {
  ...
  final String apiExtra = 'hourly=temperature_2m,relative_humidity_2m,precipitation_probability,wind_speed_10m&timezone=America%2FSanto_Domingo';
  ...
  Future<Map<String, dynamic>> fetchWeather(double lat, double lon, DateTime date) async {
    ...
    if (response.statusCode == 200) {
      ...
      Map<String, dynamic> wData = {
        ...
        "wind": res["hourly"]["wind_speed_10m"][h]
      };
      return wData;
    } else {
